	...
	<body id="container">
		<div class="success-order">
			<div class="success-order-details">
				<div class="title">成功报名 电影活动</div>
				<h3>{{$data["activity"]["info"]["title"]}}</h3>
				<div class="line"></div>
				<div class="content-details">
					<p>放映时间：<span class="color-blue">{{$data["activity"]["show_time"]}}</span></p>
				...
				<div class="remind">
					<p>SAME提示您：</p>
					<p class="description">{{$data["activity"]["info"]["summary"]}}</p>
				</div>				
			</div>
