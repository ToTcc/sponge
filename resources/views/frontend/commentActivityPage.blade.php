...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				var app = new Vue({
					...
					methods: {
						...
						submit: function() {
							...
							var activityPoint = $(".activity").attr("point");
				...
				$(".activity i").bind("click", function() {
					var index = $(this).attr("index");
					var className = "red-star";
					if(index >= 4) {
						className = "red-star";
	...
	<body id="container">
		<div class="submit-feed-back">
			<div class="title">
				<p class="main bold">{{$data["info"]["info"]["title"]}}</p>
				<p class="other"></p>
			</div>
			<div class="activity-score">
				<p>活动组织满意度</p>
				<div class="star-margin activity" point="5">
