...
<div class="login-box">
    ...
    <div class="login-box-body">
        <form action="{{URL::to('/merchant/doLogin')}}" method="get" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xs-12">
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" placeholder="用户名" name="mobile" value="{{old('email')}}">
