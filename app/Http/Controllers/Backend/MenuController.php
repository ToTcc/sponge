...
class MenuController extends Controller
{
    ...
    {
        $data = MenuRepository::paginateWhere($request->get('where'), config('repository.page-limit')); //分页
    ...
    {
        $data = $request->except(['_token', '_method', 'where', 'id']);
