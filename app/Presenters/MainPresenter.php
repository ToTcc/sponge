        ...
        foreach ($menus as $menu) {
            if ($menu['hide'] == 0) {
                if ($menu['child']) {
                    ...
                    $sidebar .= '<i class="' .$menu['icon'] .' fa-fw"></i>';
                    $sidebar .= '<span class="nav-label">' .$menu['name'] .'</span>';
                    $sidebar .= '<span class="fa arrow"></span>';
                    $sidebar .= '</a>';
                    $sidebar .= '<ul class="nav">';
                    $sidebar .= self::makeSidebar($menu['child'], $active);
                    $sidebar .= '</ul>';
                    $sidebar .= '</li>';
                } else {
                    if (in_array($menu['route'], $active)) {
                    ...
                    if (Route::has($menu['route'])) {
                        ...
                        $sidebar .= '<a class="J_menuItem" href=' .$url .'>';
